import { PortugueseGrammarTopicOption } from "../../../../../types/business";

const grammarTopicsJson: PortugueseGrammarTopicOption[] = [
  {
...
const grammarTopicsList = grammarTopicsJson.flatMap((topic) => topic.children.map((child) => child.value));
