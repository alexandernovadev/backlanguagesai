export type PortugueseGrammarTopic = 
  ...
  | "special-verbs" | "ser-estar" | "ter-haver" | "reflexive-verbs" | "modal-verbs"
...
export interface PortugueseGrammarTopicOption {
  value: PortugueseGrammarTopic;
  label: string;
  children?: PortugueseGrammarTopicOption[];
}
